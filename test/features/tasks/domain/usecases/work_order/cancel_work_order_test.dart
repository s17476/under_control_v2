...
void main() {
  ...
  setUp(() {
    ...
    usecase = CancelWorkOrder(repository: repository);
  });

  group('Tasks', () {
    test(
      'should return [VoidResult] from repository when CancelWorkOrder is called',
      () async {
        // arrange
        when(() => repository.cancelWorkOrder(any()))

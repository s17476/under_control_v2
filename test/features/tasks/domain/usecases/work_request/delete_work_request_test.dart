...
void main() {
  late DeleteWorkRequest usecase;
  ...
  setUp(() {
    ...
    usecase = DeleteWorkRequest(repository: repository);
  });

  group('Tasks', () {
    test(
      'should return [VoidResult] from repository when DeleteWorkRequest is called',
      () async {
        // arrange
        when(() => repository.deleteWorkRequest(any()))

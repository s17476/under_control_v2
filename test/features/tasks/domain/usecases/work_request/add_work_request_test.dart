...
void main() {
  ...
  setUp(() {
    ...
    usecase = AddWorkRequest(repository: repository);
  });

  group('Tasks', () {
    test(
      'should return [String] from repository when AddWorkRequest is called',
      () async {
        // arrange
        when(() => repository.addWorkRequest(any()))

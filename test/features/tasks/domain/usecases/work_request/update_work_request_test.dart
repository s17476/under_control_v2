...
void main() {
  late UpdateWorkRequest usecase;
  ...
  setUp(() {
    ...
    usecase = UpdateWorkRequest(repository: repository);
  });

  group('Tasks', () {
    test(
      'should return [VoidResult] from repository when UpdateWorkRequest is called',
      () async {
        // arrange
        when(() => repository.updateWorkRequest(any()))

...
void main() {
  late GetWorkRequestsStream usecase;
  ...
  setUp(() {
    ...
    usecase = GetWorkRequestsStream(repository: repository);
  });

  group('Tasks', () {
    test(
      'should return [WorkRequestsStream] from repository when GetWorkRequestsStream is called',
      () async {
        // arrange
        when(() => repository.getWorkRequestsStream(any())).thenAnswer(
            (_) async => Right(

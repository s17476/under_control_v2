...
void main() {
  late DeleteAssetAction usecase;
  ...
  setUp(() {
    ...
    usecase = DeleteAssetAction(repository: repository);
  });

  group('Asset Actions', () {
    test(
      'should return [VoidResult] from repository when DeleteAssetAction is called',
      () async {
        // arrange
        when(() => repository.deleteAssetAction(any())).thenAnswer(

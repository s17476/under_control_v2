...
void main() {
  late DeleteInstructionCategory usecase;
  ...
  setUp(() {
    ...
    usecase = DeleteInstructionCategory(repository: repository);
  });

  group('Knowledge Base', () {
    test(
      'should return [VoidResult] from repository when DeleteInstructionCategory is called',
      () async {
        // arrange
        when(() => repository.deleteInstructionCategory(any()))

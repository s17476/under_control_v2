          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  SizedBox(
                    height: responsiveSizeVerticalPct(small: 25, medium: 0),
                  ),
                  const FittedBox(
                    child: Padding(
                  ...
                  SizedBox(
                    height: responsiveSizeVerticalPct(small: 5, medium: 0),
                  ),
                  Text(
                    AppLocalizations.of(context)!.user_profile_add_user_welcome,

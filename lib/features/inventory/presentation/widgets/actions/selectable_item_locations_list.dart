...
import 'selectable_item_locations_list_tile.dart';

class SelectableItemLocationsList extends StatelessWidget {
  const SelectableItemLocationsList({
    Key? key,
    required this.item,
        ...
        if (state is LocationLoadedState) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return SelectableItemLocationslistTile(

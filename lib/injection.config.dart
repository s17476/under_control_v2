...
import 'features/authentication/domain/repositories/injectable_modules.dart'
    as _i256;
import 'features/core/injectable_modules/injectable_modules.dart' as _i255;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i153.GetTasksTemplatesStream>(() =>
      _i153.GetTasksTemplatesStream(
          repository: gh<_i40.TaskTemplatesRepository>()));
  gh.lazySingleton<_i154.GetUserById>(
      () => _i154.GetUserById(repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i155.GetUserStreamById>(() => _i155.GetUserStreamById(
      userRepository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i156.GetWorkRequestsStream>(() =>
      _i156.GetWorkRequestsStream(
          repository: gh<_i58.WorkRequestsRepository>()));
  gh.lazySingleton<_i157.GroupLocalDataSource>(() =>
      _i157.GroupLocalDataSourceImpl(source: gh<_i33.SharedPreferences>()));
  gh.lazySingleton<_i158.GroupRepository>(() => _i159.GroupRepositoryImpl(
        groupRemoteDataSource: gh<_i8.GroupRemoteDataSource>(),
        groupLocalDataSource: gh<_i157.GroupLocalDataSource>(),
      ));
  gh.lazySingleton<_i160.LocationLocalDataSource>(() =>
      _i160.LocationLocalDataSourceImpl(source: gh<_i33.SharedPreferences>()));
  gh.lazySingleton<_i161.LocationRepository>(() => _i162.LocationRepositoryImpl(
        locationLocalDataSource: gh<_i160.LocationLocalDataSource>(),
        locationRemoteDataSource: gh<_i23.LocationRemoteDataSource>(),
      ));
  gh.lazySingleton<_i163.MakeUserAdministrator>(() =>
      _i163.MakeUserAdministrator(
          repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i164.MarkAsRead>(
      () => _i164.MarkAsRead(repository: gh<_i42.UcNotificationRepository>()));
  gh.lazySingleton<_i165.MarkAsUnread>(() =>
      _i165.MarkAsUnread(repository: gh<_i42.UcNotificationRepository>()));
  gh.lazySingleton<_i166.RejectUser>(
      () => _i166.RejectUser(repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i167.ResetCompany>(
      () => _i167.ResetCompany(repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i168.SendPasswordResetEmail>(() =>
      _i168.SendPasswordResetEmail(
          authenticationRepository: gh<_i86.AuthenticationRepository>()));
  gh.lazySingleton<_i169.SendVerificationEmail>(() =>
      _i169.SendVerificationEmail(
          authenticationRepository: gh<_i86.AuthenticationRepository>()));
  gh.lazySingleton<_i170.Signin>(() => _i170.Signin(
      authenticationRepository: gh<_i86.AuthenticationRepository>()));
  gh.lazySingleton<_i171.Signout>(() => _i171.Signout(
      authenticationRepository: gh<_i86.AuthenticationRepository>()));
  gh.lazySingleton<_i172.Signup>(() => _i172.Signup(
      authenticationRepository: gh<_i86.AuthenticationRepository>()));
  gh.lazySingleton<_i173.SuspendUser>(
      () => _i173.SuspendUser(repository: gh<_i56.UserProfileRepository>()));
  gh.factory<_i174.TaskActionBloc>(() => _i174.TaskActionBloc(
      getTaskActionsStream: gh<_i150.GetTaskActionsStream>()));
  gh.lazySingleton<_i175.TryToGetCachedGroups>(() =>
      _i175.TryToGetCachedGroups(groupRepository: gh<_i158.GroupRepository>()));
  gh.lazySingleton<_i176.TryToGetCachedLocation>(() =>
      _i176.TryToGetCachedLocation(
          locationRepository: gh<_i161.LocationRepository>()));
  gh.lazySingleton<_i177.UnassignGroupAdmin>(() =>
      _i177.UnassignGroupAdmin(repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i178.UnassignUserFromGroup>(() =>
      _i178.UnassignUserFromGroup(
          repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i179.UnmakeUserAdministrator>(() =>
      _i179.UnmakeUserAdministrator(
          repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i180.UnsuspendUser>(
      () => _i180.UnsuspendUser(repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i181.UpdateAsset>(
      () => _i181.UpdateAsset(repository: gh<_i81.AssetRepository>()));
  gh.lazySingleton<_i182.UpdateAssetAction>(() =>
      _i182.UpdateAssetAction(repository: gh<_i77.AssetActionRepository>()));
  gh.lazySingleton<_i183.UpdateAssetCategory>(() => _i183.UpdateAssetCategory(
      repository: gh<_i79.AssetCategoryRepository>()));
  gh.lazySingleton<_i184.UpdateChecklist>(
      () => _i184.UpdateChecklist(repository: gh<_i93.CheckListsRepository>()));
  gh.lazySingleton<_i185.UpdateCompany>(() => _i185.UpdateCompany(
      companyRepository: gh<_i95.CompanyManagementRepository>()));
  gh.lazySingleton<_i186.UpdateGroup>(
      () => _i186.UpdateGroup(groupRepository: gh<_i158.GroupRepository>()));
  gh.lazySingleton<_i187.UpdateLocation>(() =>
      _i187.UpdateLocation(locationRepository: gh<_i161.LocationRepository>()));
  gh.lazySingleton<_i188.UpdateUserData>(
      () => _i188.UpdateUserData(repository: gh<_i56.UserProfileRepository>()));
  gh.lazySingleton<_i189.UpdateWorkRequest>(() =>
      _i189.UpdateWorkRequest(repository: gh<_i58.WorkRequestsRepository>()));
  gh.factory<_i190.UserManagementBloc>(() => _i190.UserManagementBloc(
        approveUser: gh<_i75.ApproveUser>(),
        approvePassiveUser: gh<_i74.ApprovePassiveUser>(),
        makeUserAdministrator: gh<_i163.MakeUserAdministrator>(),
        unmakeUserAdministrator: gh<_i179.UnmakeUserAdministrator>(),
        approveUserAndMakeAdmin: gh<_i76.ApproveUserAndMakeAdmin>(),
        rejectUser: gh<_i166.RejectUser>(),
        suspendUser: gh<_i173.SuspendUser>(),
        unsuspendUser: gh<_i180.UnsuspendUser>(),
        updateUserData: gh<_i188.UpdateUserData>(),
        assignUserToGroup: gh<_i85.AssignUserToGroup>(),
        unassignUserFromGroup: gh<_i178.UnassignUserFromGroup>(),
        assignGroupAdmin: gh<_i83.AssignGroupAdmin>(),
        unassignGroupAdmin: gh<_i177.UnassignGroupAdmin>(),
        addUserAvatar: gh<_i72.AddUserAvatar>(),
      ));
  gh.lazySingleton<_i191.AddAsset>(
      () => _i191.AddAsset(repository: gh<_i81.AssetRepository>()));
  gh.lazySingleton<_i192.AddAssetAction>(
      () => _i192.AddAssetAction(repository: gh<_i77.AssetActionRepository>()));
  gh.lazySingleton<_i193.AddAssetCategory>(() =>
      _i193.AddAssetCategory(repository: gh<_i79.AssetCategoryRepository>()));
  gh.lazySingleton<_i194.AddChecklist>(
      () => _i194.AddChecklist(repository: gh<_i93.CheckListsRepository>()));
  gh.lazySingleton<_i195.AddCompany>(() => _i195.AddCompany(
      companyManagementRepository: gh<_i95.CompanyManagementRepository>()));
  gh.lazySingleton<_i196.AddCompanyLogo>(() =>
      _i196.AddCompanyLogo(repository: gh<_i95.CompanyManagementRepository>()));
  gh.lazySingleton<_i197.AddGroup>(
      () => _i197.AddGroup(groupRepository: gh<_i158.GroupRepository>()));
  gh.lazySingleton<_i198.AddLocation>(() =>
      _i198.AddLocation(locationRepository: gh<_i161.LocationRepository>()));
  gh.factory<_i199.AssetInternalNumberCubit>(
      () => _i199.AssetInternalNumberCubit(gh<_i91.CheckCodeAvailability>()));
  gh.lazySingleton<_i200.AuthenticationBloc>(() => _i200.AuthenticationBloc(
        signin: gh<_i170.Signin>(),
        signup: gh<_i172.Signup>(),
        signout: gh<_i171.Signout>(),
        autoSignin: gh<_i88.AutoSignin>(),
        sendVerificationEmail: gh<_i169.SendVerificationEmail>(),
        checkEmailVerification: gh<_i92.CheckEmailVerification>(),
        sendPasswordResetEmail: gh<_i168.SendPasswordResetEmail>(),
        inputValidator: gh<_i9.InputValidator>(),
      ));
  gh.lazySingleton<_i201.CacheGroups>(
      () => _i201.CacheGroups(groupRepository: gh<_i158.GroupRepository>()));
  gh.lazySingleton<_i202.CacheLocation>(() =>
      _i202.CacheLocation(locationRepository: gh<_i161.LocationRepository>()));
  gh.lazySingleton<_i203.DeleteGroup>(
      () => _i203.DeleteGroup(groupRepository: gh<_i158.GroupRepository>()));
  gh.lazySingleton<_i204.DeleteLocation>(() =>
      _i204.DeleteLocation(locationRepository: gh<_i161.LocationRepository>()));
  gh.lazySingleton<_i205.FetchAllLocations>(() => _i205.FetchAllLocations(
      locationRepository: gh<_i161.LocationRepository>()));
  gh.lazySingleton<_i206.GetGroupsStream>(() =>
      _i206.GetGroupsStream(groupRepository: gh<_i158.GroupRepository>()));
  gh.factory<_i207.ItemActionBloc>(() => _i207.ItemActionBloc(
        authenticationBloc: gh<_i200.AuthenticationBloc>(),
        getItemsActionsStream: gh<_i141.GetItemsActionsStream>(),
        getLastFiveItemsActionsStream:
            gh<_i145.GetLastFiveItemsActionsStream>(),
      ));
  gh.lazySingleton<_i208.UserProfileBloc>(() => _i208.UserProfileBloc(
        authenticationBloc: gh<_i200.AuthenticationBloc>(),
        addUser: gh<_i71.AddUser>(),
        assignUserToCompany: gh<_i84.AssignUserToCompany>(),
        resetCompany: gh<_i167.ResetCompany>(),
        getUserById: gh<_i154.GetUserById>(),
        getUserStreamById: gh<_i155.GetUserStreamById>(),
        updateUserData: gh<_i188.UpdateUserData>(),
        addUserAvatar: gh<_i72.AddUserAvatar>(),
        inputValidator: gh<_i9.InputValidator>(),
      ));
  gh.factory<_i209.WorkRequestManagementBloc>(
      () => _i209.WorkRequestManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
            addWorkRequest: gh<_i73.AddWorkRequest>(),
            deleteWorkRequest: gh<_i118.DeleteWorkRequest>(),
            updateWorkRequest: gh<_i189.UpdateWorkRequest>(),
            cancelWorkRequest: gh<_i90.CancelWorkRequest>(),
          ));
  gh.factory<_i210.AssetActionBloc>(() => _i210.AssetActionBloc(
        authenticationBloc: gh<_i200.AuthenticationBloc>(),
        getAssetActionsStream: gh<_i126.GetAssetActionsStream>(),
        getLastFiveAssetActionsStream:
            gh<_i144.GetLastFiveAssetActionsStream>(),
      ));
  gh.factory<_i211.AssetActionManagementBloc>(
      () => _i211.AssetActionManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
            addAssetAction: gh<_i192.AddAssetAction>(),
            updateAssetAction: gh<_i182.UpdateAssetAction>(),
            deleteAssetAction: gh<_i105.DeleteAssetAction>(),
          ));
  gh.singleton<_i212.AssetCategoryBloc>(_i212.AssetCategoryBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    getAssetsCategoriesStream: gh<_i127.GetAssetsCategoriesStream>(),
  ));
  gh.factory<_i213.AssetCategoryManagementBloc>(
      () => _i213.AssetCategoryManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
            addAssetCategory: gh<_i193.AddAssetCategory>(),
            updateAssetCategory: gh<_i183.UpdateAssetCategory>(),
            deleteAssetCategory: gh<_i106.DeleteAssetCategory>(),
          ));
  gh.factory<_i214.AssetManagementBloc>(() => _i214.AssetManagementBloc(
        userProfileBloc: gh<_i208.UserProfileBloc>(),
        addAsset: gh<_i191.AddAsset>(),
        deleteAsset: gh<_i104.DeleteAsset>(),
        updateAsset: gh<_i181.UpdateAsset>(),
      ));
  gh.factory<_i215.AssetPartsBloc>(() => _i215.AssetPartsBloc(
        authenticationBloc: gh<_i200.AuthenticationBloc>(),
        userProfileBloc: gh<_i208.UserProfileBloc>(),
        getAssetsStreamForParent: gh<_i129.GetAssetsStreamForParent>(),
      ));
  gh.singleton<_i216.ChecklistBloc>(_i216.ChecklistBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    getChecklistsStream: gh<_i132.GetChecklistStream>(),
  ));
  gh.factory<_i217.ChecklistManagementBloc>(() => _i217.ChecklistManagementBloc(
        userProfileBloc: gh<_i208.UserProfileBloc>(),
        addChecklist: gh<_i194.AddChecklist>(),
        updateChecklist: gh<_i184.UpdateChecklist>(),
        deleteChecklist: gh<_i107.DeleteChecklist>(),
      ));
  gh.singleton<_i218.CompanyManagementBloc>(_i218.CompanyManagementBloc(
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    inputValidator: gh<_i9.InputValidator>(),
    addCompany: gh<_i195.AddCompany>(),
    fetchAllCompanies: gh<_i119.FetchAllCompanies>(),
    addCompanyLogo: gh<_i196.AddCompanyLogo>(),
    updateCompany: gh<_i185.UpdateCompany>(),
  ));
  gh.singleton<_i219.CompanyProfileBloc>(_i219.CompanyProfileBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
  ...
  gh.singleton<_i220.DeviceTokenCubit>(_i220.DeviceTokenCubit(
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    registerDeviceToken: gh<_i30.RegisterDeviceToken>(),
    removeDeviceToken: gh<_i31.RemoveDeviceToken>(),
  ));
  gh.singleton<_i221.GroupBloc>(_i221.GroupBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    companyProfileBloc: gh<_i219.CompanyProfileBloc>(),
    addGroup: gh<_i197.AddGroup>(),
    updateGroup: gh<_i186.UpdateGroup>(),
    deleteGroup: gh<_i203.DeleteGroup>(),
    getGroupsStream: gh<_i206.GetGroupsStream>(),
    cacheGroups: gh<_i201.CacheGroups>(),
    tryToGetCachedGroups: gh<_i175.TryToGetCachedGroups>(),
  ));
  gh.singleton<_i222.InstructionCategoryBloc>(_i222.InstructionCategoryBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    getInstructionsCategoriesStream:
        gh<_i139.GetInstructionsCategoriesStream>(),
  ));
  gh.factory<_i223.InstructionCategoryManagementBloc>(
      () => _i223.InstructionCategoryManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
  ...
  gh.factory<_i224.InstructionManagementBloc>(
      () => _i224.InstructionManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
  ...
  gh.factory<_i225.ItemActionManagementBloc>(
      () => _i225.ItemActionManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
  ...
  gh.singleton<_i226.ItemCategoryBloc>(_i226.ItemCategoryBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    getItemsCategoriesStream: gh<_i142.GetItemsCategoriesStream>(),
  ));
  gh.factory<_i227.ItemCategoryManagementBloc>(
      () => _i227.ItemCategoryManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
  ...
  gh.factory<_i228.ItemsManagementBloc>(() => _i228.ItemsManagementBloc(
  ...
  gh.singleton<_i229.LocationBloc>(_i229.LocationBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    addLocation: gh<_i198.AddLocation>(),
    cacheLocation: gh<_i202.CacheLocation>(),
    deleteLocation: gh<_i204.DeleteLocation>(),
    fetchAllLocations: gh<_i205.FetchAllLocations>(),
    tryToGetCachedLocation: gh<_i176.TryToGetCachedLocation>(),
    updateLocation: gh<_i187.UpdateLocation>(),
  ));
  gh.singleton<_i230.NewUsersBloc>(_i230.NewUsersBloc(
    gh<_i219.CompanyProfileBloc>(),
    gh<_i121.FetchNewUsers>(),
  ));
  gh.lazySingleton<_i231.NotificationSettingsCubit>(
      () => _i231.NotificationSettingsCubit(
            gh<_i208.UserProfileBloc>(),
            gh<_i200.AuthenticationBloc>(),
            gh<_i148.GetNotificationSettings>(),
            gh<_i50.UpdateNotificationSettings>(),
          ));
  gh.singleton<_i232.SuspendedUsersBloc>(_i232.SuspendedUsersBloc(
    gh<_i219.CompanyProfileBloc>(),
    gh<_i122.FetchSuspendedUsers>(),
  ));
  gh.factory<_i233.TaskActionManagementBloc>(
      () => _i233.TaskActionManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
            addTaskAction: gh<_i69.AddTaskAction>(),
            deleteTaskAction: gh<_i116.DeleteTaskAction>(),
            updateTaskAction: gh<_i52.UpdateTaskAction>(),
          ));
  gh.factory<_i234.TaskCubit>(() => _i234.TaskCubit(
        userProfileBloc: gh<_i208.UserProfileBloc>(),
        getTaskByIdUsecase: gh<_i151.GetTaskById>(),
      ));
  gh.factory<_i235.TaskManagementBloc>(() => _i235.TaskManagementBloc(
        userProfileBloc: gh<_i208.UserProfileBloc>(),
  ...
  gh.lazySingleton<_i236.TaskTemplatesBloc>(() => _i236.TaskTemplatesBloc(
        authenticationBloc: gh<_i200.AuthenticationBloc>(),
        userProfileBloc: gh<_i208.UserProfileBloc>(),
        getTasksTemplatesStream: gh<_i153.GetTasksTemplatesStream>(),
      ));
  gh.factory<_i237.TaskTemplatesManagementBloc>(
      () => _i237.TaskTemplatesManagementBloc(
            userProfileBloc: gh<_i208.UserProfileBloc>(),
  ...
  gh.singleton<_i238.UcNotificationBloc>(_i238.UcNotificationBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    getNotifications: gh<_i149.GetNotifications>(),
  ));
  gh.factory<_i239.UcNotificationManagementBloc>(
      () => _i239.UcNotificationManagementBloc(
            markAsRead: gh<_i164.MarkAsRead>(),
            markAsUnread: gh<_i165.MarkAsUnread>(),
            deleteNotification: gh<_i114.DeleteNotification>(),
            userProfileBloc: gh<_i208.UserProfileBloc>(),
          ));
  gh.singleton<_i240.FilterBloc>(_i240.FilterBloc(
    locationBloc: gh<_i229.LocationBloc>(),
    groupBloc: gh<_i221.GroupBloc>(),
    userProfileBloc: gh<_i208.UserProfileBloc>(),
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
  ));
  gh.singleton<_i241.InstructionBloc>(_i241.InstructionBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getInstructionsStream: gh<_i140.GetInstructionsStream>(),
  ));
  gh.singleton<_i242.ItemsBloc>(_i242.ItemsBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getChecklistsStream: gh<_i143.GetItemsStream>(),
  ));
  gh.singleton<_i243.TaskActionsStatusBloc>(_i243.TaskActionsStatusBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getLatestTaskActions: gh<_i146.GetLatestTaskActions>(),
  ));
  gh.singleton<_i244.TaskArchiveBloc>(_i244.TaskArchiveBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getArchiveTasksStream: gh<_i124.GetArchiveTasksStream>(),
  ));
  gh.singleton<_i245.TaskArchiveLatestBloc>(_i245.TaskArchiveLatestBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getArchiveLatestTasksStream: gh<_i123.GetArchiveLatestTasksStream>(),
  ));
  gh.singleton<_i246.TaskBloc>(_i246.TaskBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getTasksStream: gh<_i152.GetTasksStream>(),
  ));
  gh.singleton<_i247.WorkRequestArchiveBloc>(_i247.WorkRequestArchiveBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getArchiveWorkRequestsStream: gh<_i125.GetArchiveWorkRequestsStream>(),
  ));
  gh.singleton<_i248.WorkRequestBloc>(_i248.WorkRequestBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
    getWorkRequestsStream: gh<_i156.GetWorkRequestsStream>(),
  ));
  gh.singleton<_i249.WorkRequestsStatusBloc>(_i249.WorkRequestsStatusBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
  ...
  gh.singleton<_i250.ActivityBloc>(_i250.ActivityBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    workRequestBloc: gh<_i248.WorkRequestBloc>(),
    workRequestArchiveBloc: gh<_i247.WorkRequestArchiveBloc>(),
    taskBloc: gh<_i246.TaskBloc>(),
    taskArchiveBloc: gh<_i244.TaskArchiveBloc>(),
    taskActionsStatusBloc: gh<_i243.TaskActionsStatusBloc>(),
  ));
  gh.singleton<_i251.AssetBloc>(_i251.AssetBloc(
    filterBloc: gh<_i240.FilterBloc>(),
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    getAssetsStream: gh<_i128.GetAssetsStream>(),
  ));
  gh.singleton<_i252.DashboardAssetActionBloc>(_i252.DashboardAssetActionBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
  ...
  gh.singleton<_i253.DashboardItemActionBloc>(_i253.DashboardItemActionBloc(
    authenticationBloc: gh<_i200.AuthenticationBloc>(),
    filterBloc: gh<_i240.FilterBloc>(),
  ...
  gh.singleton<_i254.TaskFilterBloc>(_i254.TaskFilterBloc(
    gh<_i200.AuthenticationBloc>(),
    gh<_i208.UserProfileBloc>(),
    gh<_i246.TaskBloc>(),
    gh<_i248.WorkRequestBloc>(),
  ));
  return getIt;
}

class _$FirebaseFirestoreService extends _i255.FirebaseFirestoreService {}

class _$FirebaseStorageService extends _i255.FirebaseStorageService {}

class _$FirebaseMessagingService extends _i255.FirebaseMessagingService {}

class _$SharedPreferencesService extends _i255.SharedPreferencesService {}

class _$FirebaseAuthenticationService
    extends _i256.FirebaseAuthenticationService {}

class _$DataConnectionCheckerModule extends _i256.DataConnectionCheckerModule {}

...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i143.LocationLocalDataSource>(() =>
      _i143.LocationLocalDataSourceImpl(source: gh<_i26.SharedPreferences>()));
  gh.lazySingleton<_i144.LocationRepository>(() => _i145.LocationRepositoryImpl(
        locationLocalDataSource: gh<_i143.LocationLocalDataSource>(),
        locationRemoteDataSource: gh<_i22.LocationRemoteDataSource>(),
      ));
  gh.lazySingleton<_i146.MakeUserAdministrator>(() =>
      _i146.MakeUserAdministrator(
          repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i147.RejectUser>(
      () => _i147.RejectUser(repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i148.ResetCompany>(
      () => _i148.ResetCompany(repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i149.SendPasswordResetEmail>(() =>
      _i149.SendPasswordResetEmail(
          authenticationRepository: gh<_i74.AuthenticationRepository>()));
  gh.lazySingleton<_i150.SendVerificationEmail>(() =>
      _i150.SendVerificationEmail(
          authenticationRepository: gh<_i74.AuthenticationRepository>()));
  gh.lazySingleton<_i151.Signin>(() => _i151.Signin(
      authenticationRepository: gh<_i74.AuthenticationRepository>()));
  gh.lazySingleton<_i152.Signout>(() => _i152.Signout(
      authenticationRepository: gh<_i74.AuthenticationRepository>()));
  gh.lazySingleton<_i153.Signup>(() => _i153.Signup(
      authenticationRepository: gh<_i74.AuthenticationRepository>()));
  gh.lazySingleton<_i154.SuspendUser>(
      () => _i154.SuspendUser(repository: gh<_i44.UserProfileRepository>()));
  gh.factory<_i155.TaskActionBloc>(() => _i155.TaskActionBloc(
      getTaskActionsStream: gh<_i134.GetTaskActionsStream>()));
  gh.lazySingleton<_i156.TryToGetCachedGroups>(() =>
      _i156.TryToGetCachedGroups(groupRepository: gh<_i141.GroupRepository>()));
  gh.lazySingleton<_i157.TryToGetCachedLocation>(() =>
      _i157.TryToGetCachedLocation(
          locationRepository: gh<_i144.LocationRepository>()));
  gh.lazySingleton<_i158.UnassignGroupAdmin>(() =>
      _i158.UnassignGroupAdmin(repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i159.UnassignUserFromGroup>(() =>
      _i159.UnassignUserFromGroup(
          repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i160.UnmakeUserAdministrator>(() =>
      _i160.UnmakeUserAdministrator(
          repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i161.UnsuspendUser>(
      () => _i161.UnsuspendUser(repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i162.UpdateAsset>(
      () => _i162.UpdateAsset(repository: gh<_i69.AssetRepository>()));
  gh.lazySingleton<_i163.UpdateAssetAction>(() =>
      _i163.UpdateAssetAction(repository: gh<_i65.AssetActionRepository>()));
  gh.lazySingleton<_i164.UpdateAssetCategory>(() => _i164.UpdateAssetCategory(
      repository: gh<_i67.AssetCategoryRepository>()));
  gh.lazySingleton<_i165.UpdateChecklist>(
      () => _i165.UpdateChecklist(repository: gh<_i81.CheckListsRepository>()));
  gh.lazySingleton<_i166.UpdateCompany>(() => _i166.UpdateCompany(
      companyRepository: gh<_i83.CompanyManagementRepository>()));
  gh.lazySingleton<_i167.UpdateGroup>(
      () => _i167.UpdateGroup(groupRepository: gh<_i141.GroupRepository>()));
  gh.lazySingleton<_i168.UpdateLocation>(() =>
      _i168.UpdateLocation(locationRepository: gh<_i144.LocationRepository>()));
  gh.lazySingleton<_i169.UpdateUserData>(
      () => _i169.UpdateUserData(repository: gh<_i44.UserProfileRepository>()));
  gh.lazySingleton<_i170.UpdateWorkRequest>(() =>
      _i170.UpdateWorkRequest(repository: gh<_i46.WorkRequestsRepository>()));
  gh.factory<_i171.UserManagementBloc>(() => _i171.UserManagementBloc(
        approveUser: gh<_i63.ApproveUser>(),
        approvePassiveUser: gh<_i62.ApprovePassiveUser>(),
        makeUserAdministrator: gh<_i146.MakeUserAdministrator>(),
        unmakeUserAdministrator: gh<_i160.UnmakeUserAdministrator>(),
        approveUserAndMakeAdmin: gh<_i64.ApproveUserAndMakeAdmin>(),
        rejectUser: gh<_i147.RejectUser>(),
        suspendUser: gh<_i154.SuspendUser>(),
        unsuspendUser: gh<_i161.UnsuspendUser>(),
        updateUserData: gh<_i169.UpdateUserData>(),
        assignUserToGroup: gh<_i73.AssignUserToGroup>(),
        unassignUserFromGroup: gh<_i159.UnassignUserFromGroup>(),
        assignGroupAdmin: gh<_i71.AssignGroupAdmin>(),
        unassignGroupAdmin: gh<_i158.UnassignGroupAdmin>(),
        addUserAvatar: gh<_i60.AddUserAvatar>(),
      ));
  gh.lazySingleton<_i172.AddAsset>(
      () => _i172.AddAsset(repository: gh<_i69.AssetRepository>()));
  gh.lazySingleton<_i173.AddAssetAction>(
      () => _i173.AddAssetAction(repository: gh<_i65.AssetActionRepository>()));
  gh.lazySingleton<_i174.AddAssetCategory>(() =>
      _i174.AddAssetCategory(repository: gh<_i67.AssetCategoryRepository>()));
  gh.lazySingleton<_i175.AddChecklist>(
      () => _i175.AddChecklist(repository: gh<_i81.CheckListsRepository>()));
  gh.lazySingleton<_i176.AddCompany>(() => _i176.AddCompany(
      companyManagementRepository: gh<_i83.CompanyManagementRepository>()));
  gh.lazySingleton<_i177.AddCompanyLogo>(() =>
      _i177.AddCompanyLogo(repository: gh<_i83.CompanyManagementRepository>()));
  gh.lazySingleton<_i178.AddGroup>(
      () => _i178.AddGroup(groupRepository: gh<_i141.GroupRepository>()));
  gh.lazySingleton<_i179.AddLocation>(() =>
      _i179.AddLocation(locationRepository: gh<_i144.LocationRepository>()));
  gh.factory<_i180.AssetInternalNumberCubit>(
      () => _i180.AssetInternalNumberCubit(gh<_i79.CheckCodeAvailability>()));
  gh.lazySingleton<_i181.AuthenticationBloc>(() => _i181.AuthenticationBloc(
        signin: gh<_i151.Signin>(),
        signup: gh<_i153.Signup>(),
        signout: gh<_i152.Signout>(),
        autoSignin: gh<_i76.AutoSignin>(),
        sendVerificationEmail: gh<_i150.SendVerificationEmail>(),
        checkEmailVerification: gh<_i80.CheckEmailVerification>(),
        sendPasswordResetEmail: gh<_i149.SendPasswordResetEmail>(),
        inputValidator: gh<_i8.InputValidator>(),
      ));
  gh.lazySingleton<_i182.CacheGroups>(
      () => _i182.CacheGroups(groupRepository: gh<_i141.GroupRepository>()));
  gh.lazySingleton<_i183.CacheLocation>(() =>
      _i183.CacheLocation(locationRepository: gh<_i144.LocationRepository>()));
  gh.lazySingleton<_i184.DeleteGroup>(
      () => _i184.DeleteGroup(groupRepository: gh<_i141.GroupRepository>()));
  gh.lazySingleton<_i185.DeleteLocation>(() =>
      _i185.DeleteLocation(locationRepository: gh<_i144.LocationRepository>()));
  gh.lazySingleton<_i186.FetchAllLocations>(() => _i186.FetchAllLocations(
      locationRepository: gh<_i144.LocationRepository>()));
  gh.lazySingleton<_i187.GetGroupsStream>(() =>
      _i187.GetGroupsStream(groupRepository: gh<_i141.GroupRepository>()));
  gh.factory<_i188.ItemActionBloc>(() => _i188.ItemActionBloc(
  ...
  gh.lazySingleton<_i189.UserProfileBloc>(() => _i189.UserProfileBloc(
        ...
        resetCompany: gh<_i148.ResetCompany>(),
  ...
  gh.factory<_i190.WorkRequestManagementBloc>(
      () => _i190.WorkRequestManagementBloc(
            ...
            updateWorkRequest: gh<_i170.UpdateWorkRequest>(),
  ...
  gh.factory<_i192.AssetActionManagementBloc>(
      () => _i192.AssetActionManagementBloc(
            userProfileBloc: gh<_i189.UserProfileBloc>(),
            addAssetAction: gh<_i173.AddAssetAction>(),
            updateAssetAction: gh<_i163.UpdateAssetAction>(),
  ...
  gh.factory<_i194.AssetCategoryManagementBloc>(
      () => _i194.AssetCategoryManagementBloc(
            userProfileBloc: gh<_i189.UserProfileBloc>(),
            addAssetCategory: gh<_i174.AddAssetCategory>(),
            updateAssetCategory: gh<_i164.UpdateAssetCategory>(),
            deleteAssetCategory: gh<_i94.DeleteAssetCategory>(),
          ));
  gh.factory<_i195.AssetManagementBloc>(() => _i195.AssetManagementBloc(
        userProfileBloc: gh<_i189.UserProfileBloc>(),
        addAsset: gh<_i172.AddAsset>(),
        deleteAsset: gh<_i92.DeleteAsset>(),
        updateAsset: gh<_i162.UpdateAsset>(),
      ));
  ...
  gh.factory<_i198.ChecklistManagementBloc>(() => _i198.ChecklistManagementBloc(
        userProfileBloc: gh<_i189.UserProfileBloc>(),
        addChecklist: gh<_i175.AddChecklist>(),
        updateChecklist: gh<_i165.UpdateChecklist>(),
        deleteChecklist: gh<_i95.DeleteChecklist>(),
      ));
  gh.singleton<_i199.CompanyManagementBloc>(_i199.CompanyManagementBloc(
    userProfileBloc: gh<_i189.UserProfileBloc>(),
    inputValidator: gh<_i8.InputValidator>(),
    addCompany: gh<_i176.AddCompany>(),
    fetchAllCompanies: gh<_i106.FetchAllCompanies>(),
    addCompanyLogo: gh<_i177.AddCompanyLogo>(),
    updateCompany: gh<_i166.UpdateCompany>(),
  ));
  ...
  gh.singleton<_i201.GroupBloc>(_i201.GroupBloc(
    ...
    addGroup: gh<_i178.AddGroup>(),
    updateGroup: gh<_i167.UpdateGroup>(),
    deleteGroup: gh<_i184.DeleteGroup>(),
    getGroupsStream: gh<_i187.GetGroupsStream>(),
    cacheGroups: gh<_i182.CacheGroups>(),
    tryToGetCachedGroups: gh<_i156.TryToGetCachedGroups>(),
  ));
  ...
  gh.singleton<_i209.LocationBloc>(_i209.LocationBloc(
    authenticationBloc: gh<_i181.AuthenticationBloc>(),
    userProfileBloc: gh<_i189.UserProfileBloc>(),
    addLocation: gh<_i179.AddLocation>(),
    cacheLocation: gh<_i183.CacheLocation>(),
    deleteLocation: gh<_i185.DeleteLocation>(),
    fetchAllLocations: gh<_i186.FetchAllLocations>(),
    tryToGetCachedLocation: gh<_i157.TryToGetCachedLocation>(),
    updateLocation: gh<_i168.UpdateLocation>(),
  ));
